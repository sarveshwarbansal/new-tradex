...
const Cta = () => {
  ...
  <Image src={ctabg} alt="Background Image" loading="lazy" className=" hidden md:block w-full h-[300px] xl:h-[350px]" />

 
  <Image src={c} alt="Overlay Image" loading="lazy" className="  md:absolute md:top-[-4%] md:left-[25%] xl:w-[75%]   w-full h-auto z-10" />
</div>
</div>
